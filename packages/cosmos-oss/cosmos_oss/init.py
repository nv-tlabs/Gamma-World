...
from gamma_world._src.imaginaire.flags import FLAGS, VERBOSE
...
_LOGGER_INCLUDE = [
    "gamma_world._src.imaginaire.utils.checkpoint_db",
    "gamma_world._src.imaginaire.trainer",
    "*.callbacks.*",
]
_LOGGER_EXCLUDE = [
    "*._*",
    "projects.*",
    "gamma_world._src.imaginaire.*",
]
