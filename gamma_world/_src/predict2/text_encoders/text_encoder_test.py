...
Usage:
    pytest -s gamma_world/_src/predict2/text_encoders/text_encoder_test.py --L0
    pytest -s gamma_world/_src/predict2/text_encoders/text_encoder_test.py --L1
"""
...
try:
    ...
    from gamma_world._src.imaginaire.utils.embedding_concat_strategy import EmbeddingConcatStrategy
