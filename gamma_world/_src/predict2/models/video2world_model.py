...
from gamma_world._src.imaginaire.utils.high_sigma_strategy import HighSigmaStrategy as HighSigmaStrategy
...
from gamma_world._src.predict2.models.text2world_model import (
    DenoisePrediction,
    Text2WorldCondition,
    Text2WorldModelConfig,
)
from gamma_world._src.predict2.models.text2world_model import DiffusionModel as Text2WorldModel
        ...
        if is_video_batch:
            if self.config.high_sigma_strategy == str(HighSigmaStrategy.UNIFORM80_2000):
                ...
                if not hasattr(self, "hardcoded_20steps_sigma"):
                    from gamma_world._src.imaginaire.modules.res_sampler import get_rev_ts
