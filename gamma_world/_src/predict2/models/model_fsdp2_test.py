...
import gamma_world._src.imaginaire.utils.distributed
...
from gamma_world._src.predict2.configs.text2world.config import make_config
...
def model_init_test():
    gamma_world._src.imaginaire.utils.distributed.init()
    config = make_config()
