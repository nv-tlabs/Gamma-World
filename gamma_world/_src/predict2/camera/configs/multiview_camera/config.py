...
from gamma_world._src.predict2.camera.configs.multiview_camera.conditioner import register_conditioner
from gamma_world._src.predict2.camera.configs.multiview_camera.data import register_camera_data
from gamma_world._src.predict2.camera.configs.multiview_camera.model import register_model
from gamma_world._src.predict2.camera.configs.multiview_camera.net import register_net
...
def make_config() -> Config:
    ...
    import_all_modules_from_package("gamma_world._src.predict2.camera.configs.multiview_camera.experiment", reload=True)
    return c
