...
from gamma_world._src.imaginaire.datasets.augmentors.v3_text_transforms import pad_and_resize
...
from gamma_world._src.predict2.datasets.data_sources.data_registration import _CAPTION_EMBEDDING_KEY_MAPPING_IMAGES
