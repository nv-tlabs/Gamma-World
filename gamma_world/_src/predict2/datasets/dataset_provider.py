...
import gamma_world._src.imaginaire.datasets.webdataset.decoders.image as image_decoders
import gamma_world._src.imaginaire.datasets.webdataset.decoders.pickle as pickle_decoders
import gamma_world._src.imaginaire.datasets.webdataset.distributors as distributors
import gamma_world._src.predict2.datasets.decoders.video_decoder as video_decoder
...
import gamma_world._src.predict2.datasets.webdataset as webdataset
...
from gamma_world._src.predict2.datasets.augmentor_provider import AUGMENTOR_OPTIONS
from gamma_world._src.predict2.datasets.data_sources.data_registration import DATASET_OPTIONS
...
def get_image_dataset(
    ...
    image_data_config = DatasetConfig(
        ...
        # https://redacted/dir/imaginaire4/-/issues/119
        buffer_size=25,
        streaming_download=True,
        dataset_info=dataset_info,
        distributor=distributor,
