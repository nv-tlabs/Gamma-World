...
from gamma_world._src.predict2.datasets.cached_replay_dataloader import (
    duplicate_batches,
...
from gamma_world._src.predict2.text_encoders.text_encoder import EmbeddingConcatStrategy
...
T2V_REASON_EMBEDDINGS_V1P1_STAGE_C_PT_4_INDEX_26_SIZE_2B_RES_720_FPS16_RECTIFIED_FLOW_HQ_CURATION_V0_WAVER = LazyDict(
    dict(
        ...
        model=dict(
            config=dict(
                shift=3,
                conditional_frames_probs={0: 0.8, 1: 0.2, 2: 0.0},
                train_time_distribution="waver_mode_1.29",
            )
        ),
        checkpoint=dict(
            save_iter=1000,
