...
from gamma_world._src.imaginaire.utils.distributed import rank0_first
from gamma_world._src.imaginaire.utils.s3_utils import load_from_s3_with_cache
...
class BasePretrainedImageVAE(BaseVAE):
    ...
    def __init__(
        ...
        elif os.path.exists(s3_credential_path):
            self.backend_args = {
                "backend": "s3",
                "path_mapping": None,
