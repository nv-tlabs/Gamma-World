...
#
# Upstream copyright notices preserved per the MIT License terms:
# Copyright (c) 2021 OpenAI (CLIP, MIT License)
...
#     Hannaneh Hajishirzi, Ali Farhadi, Ludwig Schmidt (open_clip, MIT License)
#
# Modifications:
...
from gamma_world._src.predict2.conditioner import AbstractEmbModel
from gamma_world._src.predict2.inference.get_umt5_emb import HuggingfaceTokenizer
from gamma_world._src.predict2.networks.attention import attention
from gamma_world._src.predict2.networks.xlm_roberta import XLMRoberta
