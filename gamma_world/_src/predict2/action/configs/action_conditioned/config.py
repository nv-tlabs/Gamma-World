...
from gamma_world._src.predict2.action.configs.action_conditioned.conditioner import register_conditioner
from gamma_world._src.predict2.action.configs.action_conditioned.data import register_training_and_val_data
from gamma_world._src.predict2.action.configs.action_conditioned.model import register_model
from gamma_world._src.predict2.action.configs.action_conditioned.net import register_net
...
from gamma_world._src.predict2.configs.video2world.defaults.callbacks import register_callbacks
...
def make_config() -> Config:
    ...
    import_all_modules_from_package("gamma_world._src.predict2.configs.video2world.experiment", reload=True)

    import_all_modules_from_package(
        "gamma_world._src.predict2.action.configs.action_conditioned.experiment", reload=True
    )
    return c
