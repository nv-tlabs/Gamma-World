...
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. python gamma_world/_src/predict2/action/inference/inference_gr00t.py \
...
CUDA_VISIBLE_DEVICES=7 PYTHONPATH=. python gamma_world/_src/predict2/action/inference/inference_gr00t.py \
--experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame \
...
CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. python gamma_world/_src/predict2/action/inference/inference_gr00t.py \
--experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame \
...
CUDA_VISIBLE_DEVICES=6 PYTHONPATH=. python gamma_world/_src/predict2/action/inference/inference_gr00t.py \
--experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_49frame_full \
...
CUDA_VISIBLE_DEVICES=5 PYTHONPATH=. python gamma_world/_src/predict2/action/inference/inference_gr00t.py \
--experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame_full_16nodes \
...
from gamma_world._src.predict2.action.inference.inference_pipeline import (
