...
class ActionVideo2WorldInference:
    ...
    def __init__(
        ...
        if self.distilled:
            config_file = "projects/cosmos3/interactive/configs/registry_predict2p5.py"
            ...
            config_file = "gamma_world/_src/predict2/action/configs/action_conditioned/config.py"
