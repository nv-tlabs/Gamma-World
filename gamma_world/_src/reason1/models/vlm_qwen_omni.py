...
"""
This file is modified from gamma_world/_src/reason1/models/language_model/vlm_qwen.py for omni1 model.
"""
...
from gamma_world._src.reason1.models.vlm_base import init_mesh
from gamma_world._src.reason1.models.vlm_qwen import QwenModel
from gamma_world._src.reason1.networks.qwen2_5_vl import Qwen2_5_VisionTransformerPretrainedModel, Qwen2_5_VLModel
from gamma_world._src.reason1.networks.qwen2_5_vl import get_rope_index as get_rope_index_v2_5
from gamma_world._src.reason1.networks.qwen2_vl import Qwen2VisionTransformerPretrainedModel, Qwen2VLModel
from gamma_world._src.reason1.networks.qwen2_vl import get_rope_index as get_rope_index_v2
from gamma_world._src.reason1.parallelisms.parallelize_qwen import parallelize_qwen
...
class QwenVLBaseModel(QwenModel):
    ...
    """
    Copy from gamma_world._src.reason1.models.vlm_base.VLMBaseModel.training_step with MODIFICATIONS
