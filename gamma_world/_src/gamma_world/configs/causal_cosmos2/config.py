...
from gamma_world._src.gamma_world.configs.causal_cosmos2.defaults.model import register_model
from gamma_world._src.gamma_world.configs.causal_cosmos2.defaults.net import register_net
...
def make_config() -> Config:
    ...
    import_all_modules_from_package(
        "gamma_world._src.gamma_world.configs.causal_cosmos2.experiment", reload=True
    )
    return c
