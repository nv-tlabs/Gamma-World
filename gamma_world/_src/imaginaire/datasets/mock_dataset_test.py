...
"""
Usage:
    pytest -s gamma_world/_src/imaginaire/datasets/mock_dataset_test.py
"""

import pytest
import torch

from gamma_world._src.imaginaire.datasets.mock_dataset import CombinedDictDataset, LambdaDataset, RepeatDataset
