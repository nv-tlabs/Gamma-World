...
import gamma_world._src.imaginaire.config
import gamma_world._src.imaginaire.datasets.webdataset.dataloader
...
def create_dataloader_dict(
    config: Config, dataloader_train: gamma_world._src.imaginaire.datasets.webdataset.dataloader.DataLoader
) -> Dict:
