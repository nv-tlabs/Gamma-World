...
from gamma_world._src.imaginaire.datasets.webdataset.utils.stream import RetryingStream
...
with patch("time.sleep"):  # Skip sleep delays
    with patch("gamma_world._src.imaginaire.datasets.webdataset.utils.stream.log"):  # Suppress retry logs
        try:
...
with patch("time.sleep"):
    with patch("gamma_world._src.imaginaire.datasets.webdataset.utils.stream.log"):
        try:
