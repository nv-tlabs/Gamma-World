...
from gamma_world._src.imaginaire.attention.backends import choose_backend, choose_multi_dim_backend
from gamma_world._src.imaginaire.attention.checks import (
...
from gamma_world._src.imaginaire.attention.flash2 import flash2_attention
from gamma_world._src.imaginaire.attention.flash3 import flash3_attention
from gamma_world._src.imaginaire.attention.masks import CausalType
from gamma_world._src.imaginaire.attention.natten import natten_attention, natten_multi_dim_attention
from gamma_world._src.imaginaire.attention.utils import safe_log as log
...
def attention(
    ...
    dimension. Sequence lengths for different batches can be provided in two ways:
        ...
        2. `cumulative_seqlen_{Q,KV}` and `max_seqlen_{Q,KV}` (more efficient):
            ...
            parameters:
                ```python3
                from gamma_world._src.imaginaire.attention.varlen import generate_varlen_parameters
                (
                    cumulative_seqlen_Q,
...
def multi_dimensional_attention_varlen(
    ...
    **Requires NATTEN >= 0.21.6.dev1 and Blackwell DC-class architecture**
    ...
    from gamma_world._src.imaginaire.attention.natten import natten_supported
    ...
    from gamma_world._src.imaginaire.attention.natten.functions import natten_multi_dim_attention_varlen
