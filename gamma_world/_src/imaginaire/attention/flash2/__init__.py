...
if FLASH2_SUPPORTED:
    from gamma_world._src.imaginaire.attention.flash2.functions import flash2_attention

else:
    from gamma_world._src.imaginaire.attention.flash2.stubs import flash2_attention
