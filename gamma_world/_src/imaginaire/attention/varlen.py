...
from gamma_world._src.imaginaire.attention.utils import is_torch_compiling
...
def generate_multi_dim_varlen_parameters(
    ...
    **Requires NATTEN >= 0.21.6.dev1**
    ...
    from gamma_world._src.imaginaire.attention.natten import natten_supported, natten_version_satisfies
