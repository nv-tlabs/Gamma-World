...
if FLASH3_SUPPORTED:
    from gamma_world._src.imaginaire.attention.flash3.functions import flash3_attention

else:
    from gamma_world._src.imaginaire.attention.flash3.stubs import flash3_attention
