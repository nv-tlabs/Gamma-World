...
from gamma_world._src.imaginaire.utils.distributed import all_gather_tensor
from gamma_world._src.imaginaire.utils.easy_io import easy_io
from gamma_world._src.imaginaire.utils.timer import Timer
...
class StragglerDetectorV2:
    ...
    https://redacted/dl/gwe/fault_tolerance_related/straggler/-/tree/cupti?ref_type=heads.
        ...
        if self.enabled:
            if not straggler:
                ...
                raise RuntimeError(
                    ...
                    "Package can be installed from here: https://redacted/dl/osiris/straggler"
                )
    ...
    def generate_report(self, iteration):
        if self.enabled and iteration % self.report_freq == 0:
            ...
            if distributed.get_rank() == 0:
                ...
                import gamma_world._src.imaginaire.utils.launch

                if gamma_world._src.imaginaire.utils.launch.S3_READY and (iteration % (5 * self.report_freq) == 0) and self.save_s3:
                    easy_io.dump(
                        wandb_info,
