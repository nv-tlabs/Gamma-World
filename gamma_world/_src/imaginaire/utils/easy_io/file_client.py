...
from gamma_world._src.imaginaire.utils.easy_io.backends import BaseStorageBackend, HTTPBackend, LocalBackend
...
class FileClient:
    ...
    if TRAINING:
        try:
            from gamma_world._src.imaginaire.utils.easy_io.backends.msc_backend import MSCBackend
