...
To mitigate these issues, this module provides stable functions that ensure the gamma_world._src.imaginaire codebase remains compatible with different versions of MCore.
"""
