...
PYTHONPATH=. torchrun --nproc_per_node=8 --master_port=12341 -m gamma_world._src.predict2_multiview.scripts.inference --experiment ${EXP} --ckpt_path ${ckpt_path} --context_parallel_size 8 --input_is_train_data --max_samples 1 --num_conditional_frames 0 --guidance 3 --save_root results/predict2_multiview/
...
PYTHONPATH=. torchrun --nproc_per_node=1 --master_port=12341 -m gamma_world._src.predict2_multiview.scripts.inference --experiment ${EXP} --ckpt_path ${ckpt_path} --context_parallel_size 1 --input_is_train_data --max_samples 1 --num_conditional_frames 0 --guidance 3 --save_root results/predict2_multiview_480p_20k/
```
"""
...
from gamma_world._src.predict2_multiview.scripts.mv_visualize_helper import arrange_video_visualization
...
class Vid2VidInference:
    ...
    def __init__(
        ...
        model, config = load_model_from_checkpoint(
            ...
            config_file="gamma_world/_src/predict2_multiview/configs/vid2vid/config.py",
