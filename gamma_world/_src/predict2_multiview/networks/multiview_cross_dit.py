...
from gamma_world._src.predict2.networks.minimal_v1_lvg_dit import MinimalV1LVGDiT
from gamma_world._src.predict2.networks.minimal_v4_dit import (
    Attention,
    Block,
    SACConfig,
)
from gamma_world._src.predict2_multiview.networks.multiview_dit import (
...
class MultiViewCrossDiT(MinimalV1LVGDiT):
    ...
    def init_cross_view_attn_with_self_attn_weights(self, is_ema: bool = False) -> None:
        ...
        from gamma_world._src.imaginaire.checkpointer.s3_filesystem import S3StorageReader
